...
- [ ] **1. Fundação e esqueleto dos dois binários**
...
- [ ] **2. Persistência, migrations e ULID** (dep: 1)
...
- [ ] **3. Observabilidade e contrato de API** (dep: 1)
...
- [ ] **4. Autenticação admin (Pangolin)** (dep: 3)
...
- [ ] **7. GED com hash e segregação por paciente** (dep: 5)
...
- [ ] **7b. Perfil do terapeuta** (dep: 6, 7)
...
- [ ] **8. Sessões e ciclo de vida** (dep: 5, 6)
...
- [ ] **9. Planos e geração de débito por tipo de plano** (dep: 8)
...
- [ ] **10. PDF de cobrança + GED** (dep: 9, 7)
...
- [ ] **11. Quitação de débitos + comprovantes** (dep: 10)
...
- [ ] **13. Custos, rateio proporcional e ROI por canal** (dep: 8, 6)
...
- [ ] **14. Relatórios financeiros e de custos** (dep: 11, 13)
...
- [ ] **16. Envio de email (Gmail API)** (dep: 10, 15)
...
- [ ] **17. Auth social e cadastro** (dep: 3, 5)
...
- [ ] **18. Agenda aberta, pedido e acompanhamento** (dep: 17, 15)
